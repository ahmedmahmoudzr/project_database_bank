...
id_banlh int foreign key references customer (id_customer))
---------------------------------------------------------------
...
id_accounts int not null foreign key references accounts (id_accounts)) 
-----------------------------------------------------------
create table loan(
...
--------------------------------------------------------
INSERT INTO  bank (id_bank, name, phone) VALUES
(1, 'Bank A', '0123456789'),
(2, 'Bank B', '0123933789'),
(3, 'Bank C', '0128856789')
---------------------------------------------------
INSERT INTO branches (id_branches, name, address, id_ban) VALUES
...
-----------------------------------------------------
INSERT INTO customer_service (id_customer_service, name, report) VALUES
...
------------------------------------------------
INSERT INTO customer (id_customer, address, phone, name, id_banl) VALUES
...
------------------------------------------------------------ 
INSERT INTO  accounts (id_accounts, username, password, balance, id_banlh)
 VALUES
(1, 'User1', 1234, 1000, 1),
(2, 'User2', 5678, 2000, 2),
(3, 'User3', 9876, 1500, 3),
...
(20, '2023-01-20', 950)
-----------------------------------------
INSERT INTO  employess (id_employess, address, phone, gender, name, id_banl)
VALUES
...
------------------------------------------------------------------- 
INSERT INTO manage (id_ba, id_bd) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
update customer  set phone=01234566
where id_customer=2 ;
-------------------------------------
update customer  set name='moahmed'
where id_customer=6 ;
-------------------------------------------

update customer_service  set report='report8'
where id_customer_service=6 ;

-----------------------------------------------

update branches  set name='braned'
where id_branches=12 ;
------------------------------------------
update bank  set phone=010576849
where id_bank=12;
----------------------------------
delete from customer 
where id_customer between 7 and 9;       
-----------------------------------
delete from customer_service 
where id_customer_service =2; 
-----------------------------------     
      
delete top (8) from  bank 
-------------------------------------
delete from branches
where id_branches =9; 
--------------------------------------------
delete from employess
where id_employess =13; 
  -----------------------------------------
ALTER TABLE bank
...
select *from customer where id_customer between  4 and 9;
-------------------------------------------------------
select  gender, name,address
from employess where gender= 'female' ;
----------------------------------------------------
select address, id_banl from employess  where id_banl> 2;
-------------------------------------------------------------------------------
select gender , id_employess from employess where id_employess>5;
-----------------------------------------------------------------------------------------
select gender , id_employess ,id_banl from employess where id_employess>5 and id_banl<5;
-----------------------------------------------------------------------------------
select gender , id_employess ,name from employess where id_employess>5 or id_banl<0;
---------------------------------------------------------------------------------------------
select *from employess where phone is not null;
--------------------------------------------------------------------
select *from employess where name ='Emp1' or name ='Emp2' or name ='Emp4';
-----------------------------------------------------------------------
select *from employess where id_employess  in (1,3,5);
--------------------------------------------------------------------
select *from employess where id_banl between 3 and 9;
--------------------------------------------------------------------
select name id_employess from employess order by name ;
------------------------------------------------------------------
select name id_employess from employess order by id_employess desc ;
-------------------------------------------------------------------------
select name id_employess , id_banl from employess order by id_banl , name  ;
------------------------------------------------------------------------------
select id_employess , MAX(id_employess)"id_employess" ,MIN (id_banl)"id_banl" from employess group by id_employess;
-----------------------------------------------------------------------------------------------------------------
select id_accounts  , MAX(id_accounts)"id_accounts" ,MIN (balance) "balance", MAX (balance )"balance" from accounts group by id_accounts ;
----------------------------------------------------------------------------------------------------------------------
select id_employess , MAX(id_employess)"id_employess" ,MIN (id_banl)"id_banl" from employess group by id_employess  having MAX(id_employess)>3;
-----------------------------------------------------------------------------------------------------------------------
select   password ,username,date ,name from accounts a join transactions  t
on a.id_accounts =t.id_accounts;
-----------------------------------------------------------------------------------------------------------------------------
select   gender,address  from bank  s inner join employess  c
on s.id_bank =c.id_banl ;
--------------------------------------------------------------------------------------------------------
select   report ,phone  from customer  s inner join customer_service  c
on s.id_banl =c.id_customer_service ;
--------------------------------------------------------------------------------------------
select  phone,address  from branches s inner join bank  c
on s.id_ban =c.id_bank ;
---------------------------------------------------------------------------------------------------------------
